package net.michanide.mekanismneutronactivator.client.model;
...
public class ModelFissionNeutronActivator extends MekanismJavaModel {

    public static final ModelLayerLocation ACTIVATOR_LAYER = new ModelLayerLocation(MekanismNeutronActivator.rl("fission_neutron_activator"), "main");
    private static final ResourceLocation ACTIVATOR_TEXTURE = MekanismNeutronActivator.rl("render/fission_neutron_activator.png");
    ...
    public ModelFissionNeutronActivator(EntityModelSet entityModelSet) {

...
public class ParamNameMapper extends AbstractProcessor {
    ...
    public Set<String> getSupportedOptions() {
        return Collections.singleton(MNAAnnotationProcessors.MODULE_OPTION);
    }

    @Override
    public synchronized void init(ProcessingEnvironment processingEnv) {
        super.init(processingEnv);
        String mekModule = processingEnv.getOptions().getOrDefault(MNAAnnotationProcessors.MODULE_OPTION, "net.michanide.mekanismneutronactivator");
    }

package net.michanide.mekanismneutronactivator;
...
@SupportedAnnotationTypes(MNAAnnotationProcessors.COMPUTER_METHOD_FACTORY_ANNOTATION_CLASSNAME)
@SupportedOptions(MNAAnnotationProcessors.MODULE_OPTION)
public class MethodFactoryProcessor extends AbstractProcessor {
    private String mekModule;
    private final ClassName factoryRegistry = ClassName.get(MNAAnnotationProcessors.COMPUTER_INTEGRATION_PACKAGE, "FactoryRegistry");
    private final ClassName methodRegistryInterface = ClassName.get(MNAAnnotationProcessors.COMPUTER_INTEGRATION_PACKAGE, "IComputerMethodRegistry");
    ...
    public synchronized void init(ProcessingEnvironment processingEnv) {
        ...
        mekModule = "mekanism_neutron_activator";
    }

    @Override
    public boolean process(Set<? extends TypeElement> annotatedTypes, RoundEnvironment roundEnvironment) {
        TypeMirror methodFactoryType = processingEnv.getElementUtils().getTypeElement(MNAAnnotationProcessors.COMPUTER_METHOD_FACTORY_ANNOTATION_CLASSNAME).asType();
        ...
        if (!registryType.originatingElements.isEmpty()) {
            ...
            String packageName = "net.michanide.mekanismneutronactivator.generated." + mekModule;
            try {
    ...
    private void addHandlerToRegistry(TypeElement handledType, ClassName factoryClassName) {
        ...
        do {
            ...
            if (clazz.canonicalName().startsWith("mekanism") || clazz.canonicalName().startsWith("net.michanide.mekanismneutronactivator")) {

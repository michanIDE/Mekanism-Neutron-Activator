package net.michanide.mekanismneutronactivator.builder;
...
import net.michanide.mekanismneutronactivator.MNAAnnotationProcessors;
import net.michanide.mekanismneutronactivator.util.FakeParameter;
import net.michanide.mekanismneutronactivator.visitors.AnnotationHelper;
import net.michanide.mekanismneutronactivator.visitors.ParamToHelperMapper;
...
public class ComputerHandlerBuilder {
    ...
    private static final ClassName computerMethodFactoryRaw = ClassName.get(MNAAnnotationProcessors.COMPUTER_INTEGRATION_PACKAGE, "ComputerMethodFactory");
    private static final ClassName baseComputerHelper = ClassName.get(MNAAnnotationProcessors.COMPUTER_INTEGRATION_PACKAGE, "BaseComputerHelper");
    private static final ClassName computerException = ClassName.get(MNAAnnotationProcessors.COMPUTER_INTEGRATION_PACKAGE, "ComputerException");
    private static final ClassName methodData = ClassName.get(MNAAnnotationProcessors.COMPUTER_INTEGRATION_PACKAGE, "MethodData");
    ...
    public static void init(Elements elementUtils, Types typeUtils) {
        computerMethodAnnotationType = Objects.requireNonNull(elementUtils.getTypeElement(MNAAnnotationProcessors.ANNOTATION_COMPUTER_METHOD)).asType();
        syntheticComputerMethodAnnotationType = Objects.requireNonNull(elementUtils.getTypeElement(MNAAnnotationProcessors.ANNOTATION_SYNTHETIC_COMPUTER_METHOD)).asType();
        wrappingComputerMethodAnnotationType = Objects.requireNonNull(elementUtils.getTypeElement(MNAAnnotationProcessors.ANNOTATION_WRAPPING_COMPUTER_METHOD)).asType();
        wrappingComputerMethodDocAnnotationType = Objects.requireNonNull(elementUtils.getTypeElement(MNAAnnotationProcessors.ANNOTATION_WRAPPING_COMPUTER_METHOD_DOC)).asType();
        ...
        convertableType = Objects.requireNonNull(elementUtils.getTypeElement(MNAAnnotationProcessors.COMPUTER_INTEGRATION_PACKAGE+".Convertable")).asType();
    ...
    public ComputerHandlerBuilder(TypeElement containingType, ProcessingEnvironment env) {
        ...
        this.handlerTypeSpec = TypeSpec.classBuilder(handlerClassName)
              ...
              .addAnnotation(
                    AnnotationSpec.builder(MNAAnnotationProcessors.COMPUTER_METHOD_FACTORY_ANNOTATION)
